...
String _$dioHash() => r'26e6b9bb1481cc0c64ceff3ea16fb5f4484409a1';
...
final routerRepositoryProvider = Provider<RouterRepository>.internal(
  routerRepository,
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef RouterRepositoryRef = ProviderRef<RouterRepository>;
...
final restClientServiceProvider = AutoDisposeProvider<RestClient>.internal(
  restClientService,
  name: r'restClientServiceProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$restClientServiceHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
String _$getFilteredExpensesUseCaseHash() =>
    r'83a195cf26a8df7cfe03cb3292bda7523ba31c5f';

/// See also [getFilteredExpensesUseCase].
@ProviderFor(getFilteredExpensesUseCase)
final getFilteredExpensesUseCaseProvider =
    AutoDisposeProvider<GetFilteredExpensesUseCase>.internal(
      getFilteredExpensesUseCase,
      name: r'getFilteredExpensesUseCaseProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$getFilteredExpensesUseCaseHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
/// See also [getCurrentLocaleUseCase].
@ProviderFor(getCurrentLocaleUseCase)
final getCurrentLocaleUseCaseProvider =
    AutoDisposeProvider<GetCurrentLocaleUseCase>.internal(
      getCurrentLocaleUseCase,
      name: r'getCurrentLocaleUseCaseProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$getCurrentLocaleUseCaseHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef GetCurrentLocaleUseCaseRef =
    AutoDisposeProviderRef<GetCurrentLocaleUseCase>;
String _$setCurrentLocaleUseCaseHash() =>
    r'eef8975e559b80a2d395c006d0edc49378928b38';

/// See also [setCurrentLocaleUseCase].
@ProviderFor(setCurrentLocaleUseCase)
final setCurrentLocaleUseCaseProvider =
    AutoDisposeProvider<SetCurrentLocaleUseCase>.internal(
      setCurrentLocaleUseCase,
      name: r'setCurrentLocaleUseCaseProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$setCurrentLocaleUseCaseHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef SetCurrentLocaleUseCaseRef =
    AutoDisposeProviderRef<SetCurrentLocaleUseCase>;
